...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Stage.host'
        db.delete_column('cruiser_stage', 'host')

        # Adding field 'Stage.hosts'
        db.add_column('cruiser_stage', 'hosts',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Stage.host'
        db.add_column('cruiser_stage', 'host',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Stage.hosts'
        db.delete_column('cruiser_stage', 'hosts')
    ...
    models = {
        ...
        'cruiser.deploy': {
            ...
            'branch': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '16', 'null': 'True', 'blank': 'True'}),
        ...
        'cruiser.stage': {
            ...
            'hosts': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cruiser.Project']"}),
